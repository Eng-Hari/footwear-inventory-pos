...
export default function Home() {
  ...
  // ── Add to cart: merge by article number so the same product
  //    never creates a duplicate row regardless of id differences ──
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-5">
        ...
        <div className="relative">
          <div className={`flex items-center gap-3 bg-white border rounded-2xl px-4 py-3.5 shadow-sm transition-all duration-200
            ...
            />
            {search && (
              <button onClick={() => { setSearch(""); setProducts([]); searchRef.current?.focus(); }}
