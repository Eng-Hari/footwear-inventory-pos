...
export default function Inventory() {
  ...
  // numeric:true ensures "A2" < "A10" instead of "A10" < "A2"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-slate-100 p-4 sm:p-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                {[
                  ...
                  { label: "Color", cls: "hidden sm:table-cell" },
                  { label: "Size", cls: "hidden md:table-cell" },
                  { label: "Qty", cls: "" },
                  { label: "Purchase Price", cls: "hidden lg:table-cell" },
                  { label: "MRP", cls: "" },
                    ...
                    <tr
                      ...
                      className={`${
                        isEditing
                          ...
                          ? "bg-white"
                          : "bg-slate-50/60"
                      } hover:bg-blue-50/40 transition-colors duration-150 group`}
                    >
                      {/* # */}
                      ...
                      <td className="px-4 py-3">
                        {isEditing ? (
                          <InlineInput name="article" value={editForm.article} onChange={handleEditChange} />
                        ) : (
                      ...
                      <td className="px-4 py-3 hidden sm:table-cell text-gray-500 text-xs">
                        {isEditing ? (
                          <InlineInput name="color" value={editForm.color} onChange={handleEditChange} />
                        ) : (
        ...
        {/* Footer */}
        {filteredProducts.length > 0 && (
          <div className="px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between text-xs text-gray-400 flex-wrap gap-2">
