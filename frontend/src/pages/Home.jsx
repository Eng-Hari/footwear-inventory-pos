...
//     toast.info("🛒 Processing checkout...", { position: "top-center" });
//     if (cart.length === 0) {
...
//       toast.success("✅ Sale saved & stock updated!", { position: "top-center" });
...
//         setPaymentType("Cash");
//         setBillNumber("");
//         searchRef.current.focus(); // Re-focus after checkout
//       }, 100);
//     } catch (err) {
//       console.error("❌ Failed to save sale:", err);
//       toast.error("Failed to save sale", { position: "top-center" });
//     }
//   }
